...
from utils import decode_seq, assertFunctionEquals

def decryption(obfuscated_code, source_code, iterations_to_crack = 2000):
    ...
    for seq_index in range(1):
        ...
        translated_code = decode_seq(inp_seq, encoder_model_inf, decoder_model_inf, target_chars, target_index_to_char_dict, target_char_to_index_dict, max_len_target_sent)
        print('-')
